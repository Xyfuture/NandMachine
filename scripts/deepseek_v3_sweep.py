...
SEQUENCE_CASE_CONFIGS: tuple[SequenceCaseConfig, ...] = (
    ...
    SequenceCaseConfig(
        ...
        hbm_batch_sizes_by_ranks={
            8: (768, 512, 256, 128),  # total capacity: 1128 GiB, remaining for KV: 457 GiB, max batch size: 775
            16: (2688, 2048, 1024, 512),  # total capacity: 2256 GiB, remaining for KV: 1585 GiB, max batch size: 2690
        },
        csi_batch_sizes_by_ranks_by_slo_ms={
            50: {
            ...
            100: {
                4: (2116, 2048, 1024, 512),  # total capacity: 1920 GiB, remaining for KV: 1249 GiB, max batch size: 2120
                8: (5376, 4096, 2048, 1024),  # total capacity: 3840 GiB, remaining for KV: 3169 GiB, max batch size: 5380
                16: (11888, 8192, 4096, 2048),  # total capacity: 7680 GiB, remaining for KV: 7009 GiB, max batch size: 11899
            },
        },
        cli_batch_sizes_by_ranks_by_slo_ms={
            50: {
    ...
    SequenceCaseConfig(
        ...
        output_sequence_length=1000,
        hbm_batch_sizes_by_ranks={
            8: (328, 256, 128, 64),  # total capacity: 1128 GiB, remaining for KV: 457 GiB, max batch size: 332
            16: (1152, 1024, 512, 256),  # total capacity: 2256 GiB, remaining for KV: 1585 GiB, max batch size: 1153
        },
        csi_batch_sizes_by_ranks_by_slo_ms={
            50: {
            ...
            100: {
                4: (904, 512, 256, 128),  # total capacity: 1920 GiB, remaining for KV: 1249 GiB, max batch size: 908
                8: (2304, 2048, 1024, 512),  # total capacity: 3840 GiB, remaining for KV: 3169 GiB, max batch size: 2305
                16: (5088, 4096, 2048, 1024),  # total capacity: 7680 GiB, remaining for KV: 7009 GiB, max batch size: 5099
            },
        },
        cli_batch_sizes_by_ranks_by_slo_ms={
            50: {
