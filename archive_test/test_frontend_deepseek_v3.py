...
def test_mla_attention_codegen_uses_local_batch_and_local_blocks():
    ...
    assert macro_op_list[1].qk_latent_bmm_shape == (20, 4, 4, 2)
    assert macro_op_list[1].qk_rope_bmm_shape == (20, 4, 2, 2)
    assert macro_op_list[1].sv_latent_bmm_shape == (20, 4, 2, 4)
