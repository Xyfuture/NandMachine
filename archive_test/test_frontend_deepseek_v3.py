...
EXPECTED_NAND_MACRO_SIGNATURE = [
    ("VectorOp", (), "rms_norm", (2, 32), 16),
    ("SramPrefetch", (), 1),
    ("MatMulOp", (1, 0), (2, 32, 8), 16),
    ("SramPrefetchRelease", (2,)),
    ("VectorOp", (2,), "rms_norm", (2, 8), 16),
    ("SramPrefetch", (), 1),
    ("MatMulOp", (5, 4), (2, 8, 32), 16),
    ("SramPrefetchRelease", (6,)),
    ("SramPrefetch", (), 1),
    ("MatMulOp", (8, 6), (2, 32, 6), 16),
    ("SramPrefetchRelease", (9,)),
    ("VectorOp", (9,), "rms_norm", (2, 4), 16),
    ...
    ("SramPrefetch", (), 1),
    ("MatMulOp", (17, 16), (2, 16, 32), 16),
    ("SramPrefetchRelease", (18,)),
    ("VectorOp", (18,), "rms_norm", (2, 32), 16),
    ("SramPrefetch", (), 1),
    ("MatMulOp", (21, 20), (2, 32, 4), 16),
    ("SramPrefetchRelease", (22,)),
    ("VectorOp", (), "moe_topk_router", (2, 4, 2), 16),
    ("All2AllOp", (24,), 4, 64, 16),
    ("SramPrefetch", (), 2),
    ("MatMulOp", (26, 25), (1, 32, 24), 16),
    ("SramPrefetchRelease", (27,)),
    ("VectorOp", (), "silu_mul", (1, 12), 16),
    ("SramPrefetch", (), 1),
    ("MatMulOp", (30,), (1, 12, 32), 16),
    ("SramPrefetchRelease", (31,)),
    ("AllReduceOp", (31,), 2, 64, 16),
    ("SramPrefetch", (), 2),
    ("MatMulOp", (34,), (1, 32, 24), 16),
    ("SramPrefetchRelease", (35,)),
    ("VectorOp", (), "silu_mul", (1, 12), 16),
    ("SramPrefetch", (), 1),
    ("MatMulOp", (38,), (1, 12, 32), 16),
    ("SramPrefetchRelease", (39,)),
    ("AllReduceOp", (39,), 2, 64, 16),
    ("All2AllOp", (41,), 4, 64, 16),
    ("VectorOp", (42,), "moe_weighted_sum", (2, 32), 16),
]
